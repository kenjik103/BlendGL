...
//projectRoot assumes build was compiled from cmake-build-debug, which
//is not ideal however the fix involves a decent amount of hackish
//code and im the only one running this stuff anyway so im leaving it
//for now
